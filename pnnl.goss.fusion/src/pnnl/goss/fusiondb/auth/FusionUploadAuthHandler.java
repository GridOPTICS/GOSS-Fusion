...
@Component
public class FusionUploadAuthHandler implements AuthorizationHandler {
	private static final Logger log = LoggerFactory.getLogger(FusionUploadAuthHandler.class);
		...
		for(String perm: permissions){
			if(perm.startsWith("fusion")){
				...
				if("*".equals(type) || typeStr.equals(type)){
					if("*".equals(allowed) || "write".equals(allowed)){
						return true;
					}
				}
			}
